...
public class DirectorController extends HttpServlet {
    ...
    /*
    /director -> Ver lista paginada con todos los directores
    /director/{id} -> Ver información del director con id = {id}
    /director/all -> Ver lista con todos
    */
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (directorIdStr == null) {
            ...
            Response.outputData(response, 200, PaginationHelper.getPaginated(Director.class, actualPage, request.getParameter("name")), 4);
            return;
        }
